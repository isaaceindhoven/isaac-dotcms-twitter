...
public class TwitterUtil {
	...
	public List<CustomStatus> getUserTimeline(int count) {
		List<CustomStatus> statuses = new ArrayList<CustomStatus>();
	...
	public List<CustomStatus> searchMultipleQueries(String query, int count) {
		List<CustomStatus> tempStatusList = new ArrayList<CustomStatus>();

		//Get a list of Status based on search
		tempStatusList.addAll(search(query));	
		
		//This will remove all the duplicates
		Map<Long, CustomStatus> map = new HashMap<Long, CustomStatus>();
		...
		List<CustomStatus> uniqueStatus = new ArrayList<CustomStatus>(map.values());
	...
	private List<CustomStatus> formatStatus(List<Status> tweets) {
		List<CustomStatus> newTweets = new ArrayList<CustomStatus>();
